...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="shop-details mypadding-top">
        <%--商品圖片區--%>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">
                                    <asp:Image ID="Image1" runat="server" CssClass="product__thumb__pic set-bg" role="tab" />
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab">
                                    <asp:Image ID="Image2" runat="server" CssClass="product__thumb__pic set-bg" role="tab" />
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tabs-3" role="tab">
                                    <asp:Image ID="Image3" runat="server" CssClass="product__thumb__pic set-bg" role="tab" />
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <h4>
                                <asp:Label ID="productName" runat="server" Text=""></asp:Label></h4>
                            <h3>
                                <asp:Label ID="price" runat="server" Text=""></asp:Label></h3>
                            <p>
                                <asp:Label ID="detal" runat="server" Text=""></asp:Label>
                            </p>
                            ...
                            <div class="product__details__cart__option">
                                ...
                                <asp:Button ID="Button1" runat="server" Text="加入購物車" CssClass="primary-btn" OnClick="Button1_Click" />
                            </div>
    ...
    <section class="related spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="related-title">推薦商品</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div>
                                <a>
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="img/icon/heart.png" />
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <div>
                                <a>
                                    <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="img/icon/heart.png" />
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg">
                            <asp:ImageButton ID="Image9" runat="server" CssClass="product__item__pic set-bg" OnClick="Image9_Click" />
                        </div>
                        <div class="product__item__text">
                            ...
                            <div>
                                <a>
                                    <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="img/icon/heart.png" />
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg">
                            <asp:ImageButton ID="Image10" runat="server" CssClass="product__item__pic set-bg" OnClick="Image10_Click" />
                        </div>
                        <div class="product__item__text">
                            ...
                            <div>
                                <a>
                                    <asp:ImageButton ID="ImageButton10" runat="server" ImageUrl="img/icon/heart.png" />
