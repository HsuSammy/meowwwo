<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Product_AllProducts.aspx.cs" Inherits="Product_shop" %>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__left">
                                    <p onclick="_search()">Showing 1–12 of 126 results</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div >
                                    <div class="product__item">
                                        ...
                                        <ul class="product__hover">
                                           ...
                                           <li><id="heart"  a href="<%#Eval("ProductID","Product_Detail.aspx?id={0}")%>"><img src="img/icon/heart.png" alt=""></a></li>
...
<%--                                    <li><a href="<%#Eval("ProductID","shopping-cart.aspx?id={0}")%>"><img src="img/icon/cart.png" alt=""></a></li>--%>
                                    ...
                                    <div class="product__item__text ">
                                        <h6  id="productName"><%#Eval("productName") %></h6>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptHolder" runat="Server">
      <script>
          ...
          function _search() {
              $("#ContentPlaceHolder1_searchTxt").val("水果");
       }

          //$(function () {
          //    //1 註冊按鈕事件,AJAX程式碼移到裡面
          ...
          //        $.ajax({
          //            type: 'POST',
          //            url: "WebService.asmx/WishListAdd",
          //            contentType: "application/json;utf-8",
          //            dataType: "json",
          //            data: JSON.stringify(myData),
          //            success: function (result) {
          //                           $("#heart").text($(this).text());
