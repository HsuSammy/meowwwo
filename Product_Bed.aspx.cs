...
public partial class Product_shop : System.Web.UI.Page
{
    ...
    {
        List<Product> products = ProductUtility.GetCategory1();
    ...
    {
        string Category1= Request.QueryString["tags"];
        if (Category1 != null)
        {
            Response.Redirect($"~/Product_Bed.aspx?color=white&tags={Category1}");
        }
        else
        {
            Response.Redirect("~/Product_Bed.aspx?color=white");
        }
    }
    //黃色Btn
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Category1 != null)
        {
            Response.Redirect($"~/Product_Bed.aspx?color=yellow&tags={Category1}");
        }
        else
        {
            Response.Redirect("~/Product_Bed.aspx?color=yellow");
        }
    }
    //紅色Btn
    protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Category1 != null)
        {
            Response.Redirect($"~/Product_Bed.aspx?color=red&tags={Category1}");
        }
        else
        {
            Response.Redirect("~/Product_Bed.aspx?color=red");
        }
    }
    //綠色Btn
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (Category1 != null)
        {
            Response.Redirect($"~/Product_Bed.aspx?color=green&tags={Category1}");
        }
        else
        {
            Response.Redirect("~/Product_Bed.aspx?color=green");
        }
    }
    //食物造型tag
    protected void Button1_Click(object sender, EventArgs e)
    {
        string Category_color1 = Request.QueryString["color"];
        if (Category_color1 != null)
        {
            Response.Redirect($"~/Product_Bed.aspx?color={Category_color1}&tags=food");
        }
        else
        {
            Response.Redirect("~/Product_Bed.aspx?tags=food");
        }
    }
    //背包tag
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        if (Category_color1 != null)
        {
            Response.Redirect($"~/Product_Bed.aspx?color={Category_color1}&tags=bag");
        }
        else
        {
            Response.Redirect("~/Product_Bed.aspx?tags=bag");
        }
    }
    //動物tag
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        if (Category_color1 != null)
        {
            Response.Redirect($"~/Product_Bed.aspx?color={Category_color1}&tags=anima");
        }
        else
        {
            Response.Redirect("~/Product_Bed.aspx?tags=anima");
        }
    }
