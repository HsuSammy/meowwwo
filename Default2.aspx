...
<div class="container" >
<%--    <h1 class="text-center">Awesome Credit Card Form Example</h1>--%>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select required name="" class="form-control card-input_field" id="monthInput">
                                    <option class="disabled" readonly="10">Month</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
...
<script src="./assets/flipper.min.js" type="text/javascript"></script><%--轉頁--%>
